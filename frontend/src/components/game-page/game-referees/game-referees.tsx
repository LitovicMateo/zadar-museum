...
const GameReferees: React.FC = () => {
	...
	return (
		<div className="flex justify-center items-center">
			<div className="h-[12px] flex gap-2 text-xs font-mono items-center">
				<WhistleSVG />
				{refs?.map((ref, idx) => (
					<React.Fragment key={ref.id}>
						<Link to={APP_ROUTES.referee(ref.documentId)}>
							{ref.first_name} {ref.last_name}
						</Link>
						{idx < refs.length - 1 && <span className="mx-1">-</span>}
					</React.Fragment>
				))}
			</div>
		</div>
...
const WhistleSVG = () => {
	return (
		<svg className="h-full" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 122.88 81.03">
			<g>
