CREATE MATERIALIZED VIEW public.team_all_time_league_record_full AS
...
LEFT JOIN public.team_league_average_stats_home home USING (team_id)
LEFT JOIN public.team_league_average_stats_away away USING (team_id);