...
FROM public.zadar_player_total_all_time_league total
LEFT JOIN public.zadar_player_total_all_time_league_home home
    ON total.player_id = home.player_id
    AND total.league_id = home.league_id
LEFT JOIN public.zadar_player_total_all_time_league_away away
    ON total.player_id = away.player_id
    AND total.league_id = away.league_id
LEFT JOIN public.zadar_player_average_all_time_league avg_total
    ON total.player_id = avg_total.player_id
    AND total.league_id = avg_total.league_id
LEFT JOIN public.zadar_player_average_all_time_league_home avg_home
    ON total.player_id = avg_home.player_id
    AND total.league_id = avg_home.league_id
LEFT JOIN public.zadar_player_average_all_time_league_away avg_away
