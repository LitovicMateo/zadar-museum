...
FROM public.opponent_player_total_all_time total
LEFT JOIN public.opponent_player_total_all_time_home home USING (player_id, first_name, last_name)
LEFT JOIN public.opponent_player_total_all_time_away away USING (player_id, first_name, last_name)
LEFT JOIN public.opponent_player_average_all_time avg_total USING (player_id, first_name, last_name)
LEFT JOIN public.opponent_player_average_all_time_home avg_home USING (player_id, first_name, last_name)
LEFT JOIN public.opponent_player_average_all_time_away avg_away USING (player_id, first_name, last_name);
