...
FROM (
  ...
  FROM public.opponent_player_total_all_time_league
  ORDER BY player_id, league_id
) total
LEFT JOIN (
  SELECT DISTINCT ON (player_id, league_id) *
  FROM public.opponent_player_total_all_time_league_home
  ORDER BY player_id, league_id
) home
...
LEFT JOIN (
  SELECT DISTINCT ON (player_id, league_id) *
  FROM public.opponent_player_total_all_time_league_away
  ORDER BY player_id, league_id
) away
...
LEFT JOIN (
  SELECT DISTINCT ON (player_id, league_id) *
  FROM public.opponent_player_total_all_time_league_neutral
  ORDER BY player_id, league_id
) neutral
...
LEFT JOIN (
  SELECT DISTINCT ON (player_id, league_id) *
  FROM public.opponent_player_average_all_time_league
  ORDER BY player_id, league_id
) avg_total
...
LEFT JOIN (
  SELECT DISTINCT ON (player_id, league_id) *
  FROM public.opponent_player_average_all_time_league_home
  ORDER BY player_id, league_id
) avg_home
...
LEFT JOIN (
  SELECT DISTINCT ON (player_id, league_id) *
  FROM public.opponent_player_average_all_time_league_away
  ORDER BY player_id, league_id
) avg_away
...
LEFT JOIN (
  SELECT DISTINCT ON (player_id, league_id) *
  FROM public.opponent_player_average_all_time_league_neutral
  ORDER BY player_id, league_id
) avg_neutral
