...
WITH coaches AS (
    SELECT DISTINCT coach_id, first_name, last_name FROM public.zadar_coach_season_record
    UNION
    SELECT DISTINCT coach_id, first_name, last_name FROM public.zadar_head_coach_season_record
    UNION
    SELECT DISTINCT coach_id, first_name, last_name FROM public.zadar_assistant_coach_season_record
)
SELECT
    c.coach_id,
    c.first_name,
...
LEFT JOIN public.zadar_assistant_coach_season_league_record_away assistant_away
