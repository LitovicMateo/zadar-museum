...
FROM coaches c
LEFT JOIN public.opponent_coach_league_record total USING (coach_id)
LEFT JOIN public.opponent_coach_league_record_home home USING (coach_id)
LEFT JOIN public.opponent_coach_league_record_away away USING (coach_id)
LEFT JOIN public.opponent_head_coach_league_record head USING (coach_id)
LEFT JOIN public.opponent_head_coach_league_record_home head_home USING (coach_id)
LEFT JOIN public.opponent_head_coach_league_record_away head_away USING (coach_id)
LEFT JOIN public.opponent_assistant_coach_league_record assistant USING (coach_id)
LEFT JOIN public.opponent_assistant_coach_league_record_home assistant_home USING (coach_id)
LEFT JOIN public.opponent_assistant_coach_league_record_away assistant_away USING (coach_id)
