...
WITH coaches AS (
  SELECT
    ...
    season
  FROM (
    SELECT coach_id, first_name, last_name, season FROM public.opponent_coach_season_record
    UNION ALL
    SELECT coach_id, first_name, last_name, season FROM public.opponent_head_coach_season_record
    UNION ALL
    SELECT coach_id, first_name, last_name, season FROM public.opponent_assistant_coach_season_record
  ) t
