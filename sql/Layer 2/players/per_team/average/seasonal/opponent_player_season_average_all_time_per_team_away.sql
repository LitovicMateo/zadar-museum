CREATE MATERIALIZED VIEW public.opponent_player_season_average_all_time_per_team_away AS
 ...
 SELECT b.player_id,
  ...
  WHERE 
    ...
    b.is_nulled = false
  GROUP BY b.player_id, b.first_name, b.last_name, b.team_slug, b.season;