CREATE MATERIALIZED VIEW public.referee_season_league_stats_neutral AS
         ...
         SELECT g.id AS game_id,
           ...
           FROM games g
            ...
            WHERE 
                ...
                g.forfeited = FALSE
          GROUP BY g.id, mr.id, sr.id, tr.id, ht.id, at.id, ht.name, at.name, g.season, c.document_id, c.name, c.slug
        ), ref_game_union AS (
