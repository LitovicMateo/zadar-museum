...
CREATE INDEX IF NOT EXISTS idx_player_boxscore_player_id
    ON public.player_boxscore (player_id);
...
CREATE INDEX IF NOT EXISTS idx_player_boxscore_status
    ON public.player_boxscore (status);
...
CREATE INDEX IF NOT EXISTS idx_team_boxscore_team_id
    ON public.team_boxscore (team_id);
...
CREATE INDEX IF NOT EXISTS idx_coach_boxscore_coach_id
    ON public.coach_boxscore (coach_id);
...
CREATE INDEX IF NOT EXISTS idx_coach_boxscore_coach_role
    ON public.coach_boxscore (coach_role);
